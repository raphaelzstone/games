 ...
 * mode) as the document key so each player has one score per mode per day.
 * ========================================================================= */
...
window.GraderUser = { getOrCreateUser, setUserName, randomBirdName };
