/* Service worker — caches the app shell so Combos installs as a PWA and runs
 * offline. Bump CACHE_VERSION when you change shipped assets so users pick up
 * the new build instead of an old cached copy.
 *
...
const CACHE = `combos-${CACHE_VERSION}`;
