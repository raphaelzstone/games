...
/* Firebase web config for the Combos leaderboard.
 *
 ...
 *
 * Points at the shared "word-split" Firebase project; Combos scores live in
 * their own Firestore collection (combos_scores), so games never mix. */
window.CombosFirebaseConfig = {
