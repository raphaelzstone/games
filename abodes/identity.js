 ...
 *
 * The userId is a random opaque string; the (future) leaderboard uses
 * (userId, date) as the document key so each player has one score per day.
 * ========================================================================= */
...
window.AbodesUser = { getOrCreateUser, setUserName, randomBirdName };
